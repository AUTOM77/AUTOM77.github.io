        ...
        <header class="w-full px-6 py-4 border-b border-gray-300 dark:border-gray-700">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <nav class="flex flex-wrap items-center gap-2 text-sm">
                    ...
                    <span class="text-gray-400">|</span>
                    <a href="https://cloud.umami.is/share/02nKZkui0S6JgesC/19980224.xyz" target="_blank" class="text-primary dark:text-blue-400 hover:underline font-medium" data-i18n="nav.analytics">Analytics</a>
                    <span class="text-gray-400">|</span>
